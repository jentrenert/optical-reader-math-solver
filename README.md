...
```bash
py -m pip install --user easyocr opencv-python numpy sympy pyautogui mss pillow pynput certifi
```

## Run

Run these commands from the folder that contains `gui.py`:

```bash
cd mathimatical_bot-main
python gui.py
```
